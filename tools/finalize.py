...
Run this ONCE after any formatting/generation pass. It is idempotent, so
running it repeatedly is safe. It fixes the things that break the published
site (https://ijk37.com/data-analytics-excel/):
...
LIVE_SITE_BADGE = (
    ...
    '(https://ijk37.com/data-analytics-excel/)'
)


def ensure_live_site_badge(s: str) -> str:
    """Insert the live-site badge on the line after the banner, once."""
...
def fix_file(path: str) -> bool:
    ...
    # live-site badge under the banner (README pages only)
